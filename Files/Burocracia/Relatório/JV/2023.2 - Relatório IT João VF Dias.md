...
Seguindo a sequência explícita na metodologia, traz-se aqui os resultados atingidos pela equipe ao longo dos meses de projeto. Ao longo da jornada, considerando a inexperiência dos integrantes, foram encontrados diversos desafios, que serão discutidos ao longo desta seção.
...
Quanto aos resultados, podemos começar pelos objetivos geral, onde temos a construção de diversos robôs. Como considerou-se que a categoria fairy embora possa ser mais barata por necessitar de eletrônicos menos potentes e também menos materiais, ela requere um nível de precisão e entendimento do funcionamento dos componentes eletrônicos muito maior. Ainda assim, considerou-se válido seguir com um modelo pré-existente, que é o [UnderScore 150gram combat robot][link1], sendo ele o remix de [Antweight Combat Spinner Bot - Shrapnel Mk1][link2] que dispões da listagem dos componentes necessários para a montagem.


[link1]: https://www.thingiverse.com/thing:3173115
[link2]: https://www.thingiverse.com/thing:1692075
...
### 4.2 Entendimento do cenário atual

### 4.3 Dimensionamento elétrico e modelagem 3D
